        ...
        <div class="col-lg-6 col-md-6">
            <div style="display: flex; justify-content: center;">
                <div class="thumbnail-images">
                    <img class="product-thumbnail" src="{{asset('frontend')}}/img/5888.jpg" alt="Product thumbnail 1" onclick="changeMainImage('{{asset('frontend')}}/img/5888.jpg')">
                    <img class="product-thumbnail" src="{{asset('frontend')}}/img/1 (1).jpg" alt="Product thumbnail 2" onclick="changeMainImage('{{asset('frontend')}}/img/1 (1).jpg')">
                    <img class="product-thumbnail" src="{{asset('frontend')}}/img/1 (3).jpg" alt="Product thumbnail 3" onclick="changeMainImage('{{asset('frontend')}}/img/1 (3).jpg')">
                    <img class="product-thumbnail" src="{{asset('frontend')}}/img/1 (2).jpg" alt="Product thumbnail 4" onclick="changeMainImage('{{asset('frontend')}}/img/1 (2).jpg')">
                </div>
                <div class="product-gallery">
                    <div class="main-image">
                        <a href="#"><img id="mainImage" class="product-main-img" src="{{asset('frontend')}}/img/5888.jpg" alt="Main product image"></a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="bg-light">
    <div class="container mt-3">
        <img src="{{asset('frontend')}}/img/1 (1).jpg" class="img-fluid mb-3" alt="">
        <img src="{{asset('frontend')}}/img/1 (2).jpg" class="img-fluid mb-3" alt="">
        <img src="{{asset('frontend')}}/img/1 (3).jpg" class="img-fluid mb-3" alt="">
